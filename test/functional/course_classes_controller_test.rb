...
class CourseClassesControllerTest < ActionController::TestCase
  ...
  test "should create course_class" do
    assert_difference('CourseClass.count') do
      post :create, course_class: { course_id: @course_class.course_id, name: @course_class.name, teacher_id: @course_class.teacher_id }
    end
  ...
  test "should update course_class" do
    put :update, id: @course_class, course_class: { course_id: @course_class.course_id, name: @course_class.name, teacher_id: @course_class.teacher_id }
    assert_redirected_to course_class_path(assigns(:course_class))
  end
